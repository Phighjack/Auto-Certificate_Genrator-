...
def sendmail(name, toaddr, attach_file):
    ...
    body = "Dear "+name+", <br><br>Please find attached your certificate. <br><br> Best Regards <br><br>COMSA and IEEE <br><br>Form DKTE Textile And Engineering Institute"
